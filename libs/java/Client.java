...
public class Client {
	...
	public ArrayList<Input> get_inputs() {

		Map<String, String> parameters = new HashMap<String, String>();
		String url = this.room.getVidi().getAddress() + "/bindings/io";
		parameters.put("apikey", this.room.getVidi().getApikey());
		ArrayList<Binding> bindings = this.room.get_bindings();
	...
	public ArrayList<Output> get_outputs() {
	...
	public Input get_input(String id) {

		return new Input(this.room, id);
	}

	public Output get_output(String id) {
